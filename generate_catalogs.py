...
def cover(title: str, subtitle: str, cover_image: str | None = None) -> list:
    ...
    elements.append(Paragraph("26 лет работы в Камышине. Только фабричная мебель и официальные поставщики.", S["cover_subtitle"]))
...
def contact_page() -> list:
    return [
        ...
        p("Магазин работает с официальными фабриками и документами. Кустарные производства не используем.", "body"),
        Spacer(1, 6 * mm),
...
CATALOGS = {
    "divany.pdf": {
        "title": "Мягкая мебель",
        "subtitle": "Диваны, кресла, механизмы и брендовые обивки под интерьер",
        ...
        "sections": [
            {
                ...
                "items": [
                    ...
                    "стандартные и премиальные ткани по образцам в магазине",
                    "подбор цвета дивана в магазине или дистанционно",
                    "уточнение паспортного срока службы по документам фабрики",
                ],
                "note": "Цифровые фото от фабрик ожидаются к августу. До этого работаем по образцам, каталогам и консультации. Многие клиенты возвращаются за новой мягкой мебелью спустя годы эксплуатации прежних диванов.",
            }
        ],
    },
    "krovati.pdf": {
        ...
        "sections": [
            {
                ...
                "items": [
                    ...
                    "официальные фабрики и документы на продукцию",
                ],
        ...
        "sections": [
            {
                ...
                "items": [
                    ...
                    "подбор столешницы, мойки и смесителя под один комплект",
                ],
            ...
            },
            {
                ...
                "items": [
                    ...
                    "раздвижные столы, металлический каркас и надежная фурнитура",
                    "влагостойкие пластиковые поверхности для кухни",
                    "мойки и кухонные марки GranFest, PREMIAL, MARRBAXX, MAXSTONE",
                    "металлические, керамические и каменные мойки",
                    "смесители можно подобрать в цвет камня",
                    "часть моек комплектуется сифонами",
                    "подбор цвета, формы и размера",
                ],
                "note": "Декоры СКИФ и Кедр подбираются по образцам и онлайн-каталогам. По мойкам делаем упор на хорошие российские предложения вместо импортных поставок.",
            },
        ],
    },
}
