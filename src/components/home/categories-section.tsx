        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {SHOWROOM_PHOTOS.map((cat, i) => (
            ...
            >
              <Link
                href={cat.href}
                className="group block bg-background rounded-2xl overflow-hidden border border-border hover:border-primary/30 hover:shadow-md transition-all duration-300 no-underline h-full"
              >
                <div
